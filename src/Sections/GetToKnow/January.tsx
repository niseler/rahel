...
export const January = () => {
  return (
    <>
      <h1 id="Januar" className="font-bold">
        Januar
      </h1>
      <GetToKnow
      ...
      <GetToKnow
        ...
        data={['es war sehr angenehm und wir haben uns gut verstanden', 'die Dauer betrug ca 1,5 Stunden']}
      />
      <GetToKnow
      ...
      <GetToKnow
        ...
        data={['du bist das erste Mal bei mir zu Besuch', 'dabei lernst du kurz Samu und Fina kennen']}
      />

      <GetToKnow
        header={'So, 28.01. zweiter Besuch bei mir'}
        data={['diesmal schlafen die Kids', 'Ich habe ein paar Teelichter aufgestellt']}
      />
    </>
  );
};
