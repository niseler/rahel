...
export const April = () => {
  return (
    <>
      <h1 id="April" className="font-bold">
        April
      </h1>
      <GetToKnow
      ...
      />
      <GetToKnow
        header={'Fr, 12.04 Geburtstag Ypsi'}
        data={[
          'wir sind bei Ypsi zum Geburtstag eingeladen',
          'die Feier findet im Garten statt und anschließend sitzen wir drinnen gemütlich zusammen'
        ]}
      />
      <GetToKnow
        header={'Sa,So, 13/14.04 Grillen und Chillen'}
        data={[
          'wir chillen entspannt bei dir auf dem Balkon',
          'nachmittags gehen wir in den Park und treffen dort zufällig Ypsi und Tobi',
          'wir spielen mit Juli Fußball und werfen den Ring',
          'Abends grillen wir mit ein paar Nachbarn aus deinem Haus und sitzen an der Feuerschale',
          'am Sonntag frühstücken wir gemütlich und chillen wieder entspannt auf dem Balkon',
          'Abends fahren wir noch zu mir und Juli lernt mein zu Hause kennen'
        ]}
      />
      <GetToKnow
        header={'So, 21.04 Kennenlernen der Kinder'}
        data={[
          'du kommst mit Juli zu uns zu besuch',
          'Juli und Samu spielen Fußball und MineCraft und auch Fina mag Juli',
          'wir vespern und verlegen das chillen nach drinnen da es doch recht kühl ist'
        ]}
      />
    </>
  );
